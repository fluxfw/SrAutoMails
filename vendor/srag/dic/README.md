...
```php
\srag\DIC\SrAutoMails\x\DICStatic::dic()->database()->createAutoIncrement(\srag\Plugins\x\x\x::TABLE_NAME, "id");
```
...
```php
...
use srag\DIC\SrAutoMails\x\DevTools\DevToolsCtrl;
...
    /**
     * @inheritDoc
     */
...
/**
 * ...
 * @ilCtrl_isCalledBy srag\DIC\SrAutoMails\x\DevTools\DevToolsCtrl: ilXConfigGUI
 */
class ...
...
    /**
