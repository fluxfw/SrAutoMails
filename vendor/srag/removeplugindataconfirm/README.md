...
```php
//...
use srag\RemovePluginDataConfirm\SrAutoMails\x\PluginUninstallTrait;
//...
...
```php
//...
use srag\RemovePluginDataConfirm\SrAutoMails\x\RepositoryObjectPluginUninstallTrait;
//...
